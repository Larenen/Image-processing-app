...
namespace APO
{
        ...
        public override int Count
        {
            get
            {
                if (Grid.DataSource == null)
                    ...
                    return Grid.DataSource.GetLength(1) + Grid.FixedRows;
            }
        }
        ...
        public override int Count
        {
            get
            {
                if (Grid.DataSource == null)
                    ...
                    return Grid.DataSource.GetLength(0) + Grid.FixedColumns;
            }
        }
    ...
    public class ImageValueModel : SourceGrid.Cells.Models.IValueModel
    {
        ...
        {
            int[,] bitmap = ((ImageGrid)cellContext.Grid).DataSource;
